...
class VideoService():
    ...
    def initialize(self):
        ...
        self.font = pygame.font.Font('/Users/ryanmadsen/code/python/minesweeper/VCR_OSD_MONO_1.001.ttf', self.font_size)
        self.load_images()


    def load_images(self):
        self.smiley = pygame.image.load("/Users/ryanmadsen/code/python/minesweeper/images/smiley.png")
        self.frowney = pygame.image.load("/Users/ryanmadsen/code/python/minesweeper/images/omg.png")
        self.bomb = pygame.image.load("/Users/ryanmadsen/code/python/minesweeper/images/bomb.png")
        self.flag = pygame.image.load("/Users/ryanmadsen/code/python/minesweeper/images/flag.png")
    ...
    def draw_header(self):
        ...
        time_text = self.font.render(f"{str(self.clock.minutes_elapsed).zfill(2)}:{str(self.clock.seconds_elapsed).zfill(2)}", True, (235, 64, 52), None)
        ...
        squares_cleared_text = self.font.render(f"{str(self.board.count_spaces_cleared()).zfill(2)}", True, (235, 64, 52), None)
